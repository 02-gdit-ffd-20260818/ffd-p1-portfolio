...
当前主分支为第 3 次课 `P1 v1.2.0` 教师 solution；历史课次可从 Release 恢复。本仓库不直接作为学生最终答案发放。示例身份和联系方式均为虚构信息，正式使用时仍应避免公开学生隐私。
...
预期结果：HTML/CSS 检查通过、9 个自动测试通过、生成 `dist`，页面从 JavaScript 数据生成三张项目卡。
